...
namespace ViteMontevideo_API.Migrations
{
    ...
    [Migration("20231026230106_QuitarUniqueConstraintTrabajadores")]
    partial class QuitarUniqueConstraintTrabajadores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViteMontevideo_API.models.Turno", b =>
                {
                    b.Property<short>("IdTurno")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<short>("IdTurno"));
                    ...
                    b.HasKey("IdTurno")
                        .HasName("PK__Turnos__C68E739728A55513");
            ...
            modelBuilder.Entity("ViteMontevideo_API.models.Egreso", b =>
                {
                    b.HasOne("ViteMontevideo_API.models.CajaChica", "IdCajaNavigation")
                        .WithMany("Egresos")
            ...
            modelBuilder.Entity("ViteMontevideo_API.models.Tarifa", b =>
                {
                    ...
                    b.HasOne("ViteMontevideo_API.models.Turno", "oTurno")
                        .WithMany("Tarifas")
                        .HasForeignKey("IdTurno")
                        .HasConstraintName("Fk_Tarifas_Turnos");

...
namespace ViteMontevideo_API.Migrations
{
    ...
    [Migration("20250109041353_AgregarTriggersServicios")]
    partial class AgregarTriggersServicios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Actividad", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.CajaChica", b =>
                {
                    ...
                    b.Property<decimal>("TotalMontoAbonados")
                        .HasColumnType("money")
                        .HasColumnName("total_monto_abonados");

                    b.Property<decimal>("TotalMontoComerciosAdicionales")
                        .HasColumnType("money")
                        .HasColumnName("total_monto_comercios_adicionales");

                    b.Property<decimal>("TotalMontoEgresos")
                        .HasColumnType("money")
                        .HasColumnName("total_monto_egresos");

                    b.Property<decimal>("TotalMontoServicios")
                        .HasColumnType("money")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Cargo", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Categoria", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.ComercioAdicional", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.ContratoAbonado", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Egreso", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Servicio", b =>
                {
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Tarifa", b =>
                {
                    b.Property<short>("IdTarifa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Trabajador", b =>
                {
                    b.Property<short>("IdTrabajador")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Usuario", b =>
                {
                    b.Property<short>("IdUsuario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Vehiculo", b =>
                {
                    b.Property<int>("IdVehiculo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.CajaChica", b =>
                {
                    b.HasOne("ViteMontevideo_API.Persistence.Models.Trabajador", "Trabajador")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.ComercioAdicional", b =>
                {
                    b.HasOne("ViteMontevideo_API.Persistence.Models.CajaChica", "CajaChica")
                        .WithMany("ComerciosAdicionales")
                        .HasForeignKey("IdCaja")
                        .HasConstraintName("Fk_ComerciosAdicionales_CajasChicas");

                    b.HasOne("ViteMontevideo_API.Persistence.Models.Cliente", "Cliente")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.ContratoAbonado", b =>
                {
                    ...
                    b.HasOne("ViteMontevideo_API.Persistence.Models.Vehiculo", "Vehiculo")
                        .WithMany("ContratosAbonados")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Servicio", b =>
                {
                    ...
                    b.HasOne("ViteMontevideo_API.Persistence.Models.Tarifa", "Tarifa")
                        .WithMany("Servicios")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Tarifa", b =>
                {
                    b.HasOne("ViteMontevideo_API.Persistence.Models.Actividad", "Actividad")
                        .WithMany("Tarifas")
                        .HasForeignKey("IdActividad")
                        .IsRequired()
                        .HasConstraintName("Fk_Tarifas_Actividades");

                    b.HasOne("ViteMontevideo_API.Persistence.Models.Categoria", "Categoria")
                        .WithMany("Tarifas")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.Trabajador", b =>
                {
                    b.HasOne("ViteMontevideo_API.Persistence.Models.Cargo", "Cargo")
                        .WithMany("Trabajadores")
                        .HasForeignKey("IdCargo")
                        .IsRequired()
                        .HasConstraintName("Fk_Trabajadores_Cargos");

                    b.HasOne("ViteMontevideo_API.Persistence.Models.Usuario", "OUsuario")
                        .WithMany("Trabajadores")
            ...
            modelBuilder.Entity("ViteMontevideo_API.Persistence.Models.CajaChica", b =>
                {
                    b.Navigation("ComerciosAdicionales");
